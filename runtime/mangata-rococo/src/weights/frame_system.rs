...
impl<T: frame_system::Config> frame_system::WeightInfo for ModuleWeight<T> {
	fn remark(b: u32, ) -> Weight {
		(Weight::from_ref_time(8_893_634))
			// Standard Error: 0
			.saturating_add((Weight::from_ref_time(520)).saturating_mul(b as u64))
	}
	fn remark_with_event(b: u32, ) -> Weight {
		(Weight::from_ref_time(21_071_947))
			// Standard Error: 0
			.saturating_add((Weight::from_ref_time(1_773)).saturating_mul(b as u64))
	}
	// Storage: System Digest (r:1 w:1)
	// Storage: unknown [0x3a686561707061676573] (r:0 w:1)
	fn set_heap_pages() -> Weight {
		(Weight::from_ref_time(11_920_000))
	...
	fn set_storage(i: u32, ) -> Weight {
		(Weight::from_ref_time(6_530_000))
			...
			.saturating_add((Weight::from_ref_time(1_010_531)).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn kill_storage(i: u32, ) -> Weight {
		(Weight::from_ref_time(6_460_000))
			// Standard Error: 1_456
			.saturating_add((Weight::from_ref_time(823_781)).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn kill_prefix(p: u32, ) -> Weight {
		(Weight::from_ref_time(9_200_000))
			...
			.saturating_add((Weight::from_ref_time(1_533_512)).saturating_mul(p as u64))
