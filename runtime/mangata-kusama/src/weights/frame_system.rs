...
impl<T: frame_system::Config> frame_system::WeightInfo for ModuleWeight<T> {
	fn remark(b: u32, ) -> Weight {
		(Weight::from_parts(9_964_525, 0))
			// Standard Error: 0
			.saturating_add((Weight::from_parts(589, 0)).saturating_mul(b as u64))
	}
	fn remark_with_event(b: u32, ) -> Weight {
		(Weight::from_parts(29_205_376, 0))
			// Standard Error: 0
			.saturating_add((Weight::from_parts(1_778, 0)).saturating_mul(b as u64))
	}
	...
	fn set_storage(i: u32, ) -> Weight {
		(Weight::from_parts(4_160_000, 0))
			...
			.saturating_add((Weight::from_parts(1_226_647, 0)).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		(Weight::from_parts(4_090_000, 0))
			...
			.saturating_add((Weight::from_parts(840_132, 0)).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	fn kill_prefix(p: u32, ) -> Weight {
		(Weight::from_parts(7_640_000, 0))
			...
			.saturating_add((Weight::from_parts(1_459_706, 0)).saturating_mul(p as u64))
