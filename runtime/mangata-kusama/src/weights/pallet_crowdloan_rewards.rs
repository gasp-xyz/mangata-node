...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for ModuleWeight<T> {
	...
	fn set_crowdloan_allocation() -> Weight {
		(Weight::from_ref_time(7_550_000))
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		(Weight::from_ref_time(1_214_588_094))
			// Standard Error: 84_297
			.saturating_add((Weight::from_ref_time(57_582_633)).saturating_mul(x as u64))
	...
	fn complete_initialization() -> Weight {
		(Weight::from_ref_time(27_110_000))
	...
	// Storage: Tokens TotalIssuance (r:1 w:1)
	fn claim() -> Weight {
		(Weight::from_ref_time(76_050_000))
			.saturating_add(T::DbWeight::get().reads(7 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Crowdloan AccountsPayable (r:2 w:2)
	fn update_reward_address() -> Weight {
		(Weight::from_ref_time(42_420_000))
	...
	// Storage: Tokens TotalIssuance (r:1 w:1)
	fn associate_native_identity() -> Weight {
		(Weight::from_ref_time(154_820_000))
			.saturating_add(T::DbWeight::get().reads(6 as u64))
			.saturating_add(T::DbWeight::get().writes(5 as u64))
	}
	// Storage: Crowdloan AccountsPayable (r:2 w:2)
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		(Weight::from_ref_time(48_036_834))
			// Standard Error: 10_687
			.saturating_add((Weight::from_ref_time(62_819_082)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
