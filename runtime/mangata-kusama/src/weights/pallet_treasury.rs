...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for ModuleWeight<T> {
	...
	fn reject_proposal() -> Weight {
		(Weight::from_ref_time(56_170_000))
	...
	fn approve_proposal(p: u32, ) -> Weight {
		(Weight::from_ref_time(22_167_627))
			// Standard Error: 1_510
			.saturating_add((Weight::from_ref_time(307_751)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		(Weight::from_ref_time(37_189_330))
			// Standard Error: 5_817
			.saturating_add((Weight::from_ref_time(3_624_621)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
