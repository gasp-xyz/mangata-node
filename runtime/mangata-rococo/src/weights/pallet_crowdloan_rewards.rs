...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for ModuleWeight<T> {
	...
	// Proof Skipped: Crowdloan CrowdloanId (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Crowdloan InitializedRewardAmount (r:1 w:0)
	// Proof Skipped: Crowdloan InitializedRewardAmount (max_values: None, max_size: None, mode: Measured)
	// Storage: Crowdloan CrowdloanAllocation (r:0 w:1)
	// Proof Skipped: Crowdloan CrowdloanAllocation (max_values: None, max_size: None, mode: Measured)
	fn set_crowdloan_allocation() -> Weight {
	...
	// Proof Skipped: Crowdloan TotalContributors (max_values: None, max_size: None, mode: Measured)
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		(Weight::from_parts(95_783_300, 0))
			// Standard Error: 25_873
			.saturating_add((Weight::from_parts(24_362_858, 0)).saturating_mul(x as u64))
	...
	// Proof Skipped: Crowdloan CrowdloanPeriod (max_values: None, max_size: None, mode: Measured)
	fn complete_initialization() -> Weight {
	...
	// Proof Skipped: Crowdloan AccountsPayable (max_values: None, max_size: None, mode: Measured)
	fn associate_native_identity() -> Weight {
		(Weight::from_parts(114_790_000, 0))
	...
	// Proof Skipped: Crowdloan AccountsPayable (max_values: None, max_size: None, mode: Measured)
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		(Weight::from_parts(42_648_512, 0))
			// Standard Error: 10_539
			.saturating_add((Weight::from_parts(63_038_369, 0)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
