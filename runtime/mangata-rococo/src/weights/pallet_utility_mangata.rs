...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_parts(13_549_165, 0))
			// Standard Error: 21_923
			.saturating_add((Weight::from_parts(9_941_900, 0)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_parts(9_530_000, 0))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_parts(65_951_534, 0))
			// Standard Error: 21_524
			.saturating_add((Weight::from_parts(10_171_670, 0)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_parts(15_020_000, 0))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_parts(10_184_050, 0))
			// Standard Error: 19_026
			.saturating_add((Weight::from_parts(9_809_616, 0)).saturating_mul(c as u64))
	}
}
