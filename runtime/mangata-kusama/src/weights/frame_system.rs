...
impl<T: frame_system::Config> frame_system::WeightInfo for ModuleWeight<T> {
	fn remark(b: u32, ) -> Weight {
		(Weight::from_parts(104_149_921, 0))
			// Standard Error: 10
			.saturating_add((Weight::from_parts(342, 0)).saturating_mul(b as u64))
	}
	fn remark_with_event(b: u32, ) -> Weight {
		(Weight::from_parts(36_476_892, 0))
			// Standard Error: 1
			.saturating_add((Weight::from_parts(1_578, 0)).saturating_mul(b as u64))
	}
	...
	fn set_code() -> Weight {
		(Weight::from_parts(163_229_366_000, 0))
	...
	fn set_storage(i: u32, ) -> Weight {
		(Weight::from_parts(3_940_000, 0))
			...
			.saturating_add((Weight::from_parts(1_342_924, 0)).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		(Weight::from_parts(4_040_000, 0))
			...
			.saturating_add((Weight::from_parts(915_962, 0)).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: `Skipped::Metadata` (r:0 w:0)
	// Proof: `Skipped::Metadata` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn kill_prefix(p: u32, ) -> Weight {
		(Weight::from_parts(7_650_000, 0))
			...
			.saturating_add((Weight::from_parts(1_599_167, 0)).saturating_mul(p as u64))
