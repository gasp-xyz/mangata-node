...
pub struct TxnRegistryDetails<AccountId: Parameter, Hash: Parameter> {
	...
	pub user: AccountId,
	pub singly_encrypted_call_hash: sp_core::H256,
	pub decrypted_call_hash: sp_core::H256,
	pub weight: Weight,
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn submit_doubly_encrypted_transaction(
			...
			pub_key: [u8; 32],
			singly_encrypted_call_hash: sp_core::H256,
			decrypted_call_hash: sp_core::H256,
			fee: Balance,
			weight: Weight,
			builder: T::AccountId,
