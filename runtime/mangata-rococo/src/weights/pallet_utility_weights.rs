...
impl<T: frame_system::Config> pallet_utility::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(18_285_000 as Weight)
			...
			.saturating_add((4_405_000 as Weight).saturating_mul(c as Weight))
	}
	fn as_derivative() -> Weight {
		(3_000_000 as Weight)
	}
	fn batch_all(c: u32, ) -> Weight {
		(21_831_000 as Weight)
			// Standard Error: 1_000
			.saturating_add((4_773_000 as Weight).saturating_mul(c as Weight))
	}
	fn dispatch_as() -> Weight {
	...
	fn force_batch(c: u32, ) -> Weight {
		(20_918_000 as Weight)
			// Standard Error: 1_000
			.saturating_add((4_359_000 as Weight).saturating_mul(c as Weight))
	}
}
