...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_ref_time(28_144_129))
			// Standard Error: 2_328
			.saturating_add((Weight::from_ref_time(6_913_133)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_ref_time(12_310_000))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_ref_time(27_701_156))
			// Standard Error: 2_006
			.saturating_add((Weight::from_ref_time(7_149_599)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_ref_time(22_900_000))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_ref_time(27_874_962))
			// Standard Error: 2_958
			.saturating_add((Weight::from_ref_time(6_918_456)).saturating_mul(c as u64))
	}
}
