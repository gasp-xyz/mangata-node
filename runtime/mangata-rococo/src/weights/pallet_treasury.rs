...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for ModuleWeight<T> {
	...
	fn reject_proposal() -> Weight {
		(Weight::from_ref_time(49_169_000))
	...
	fn approve_proposal(p: u32, ) -> Weight {
		(Weight::from_ref_time(22_541_000))
			// Standard Error: 1_000
			.saturating_add((Weight::from_ref_time(292_000)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Treasury Approvals (r:1 w:1)
	fn remove_approval() -> Weight {
		(Weight::from_ref_time(15_850_000))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		(Weight::from_ref_time(38_228_000))
			// Standard Error: 5_000
			.saturating_add((Weight::from_ref_time(3_561_000)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
