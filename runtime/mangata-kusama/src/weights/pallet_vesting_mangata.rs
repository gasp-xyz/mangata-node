...
impl<T: frame_system::Config> pallet_vesting_mangata::WeightInfo for ModuleWeight<T> {
	...
	fn vest_locked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(55_324_712))
			// Standard Error: 5_344
			.saturating_add((Weight::from_ref_time(180_477)).saturating_mul(s as u64))
	...
	fn vest_unlocked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(64_158_213))
			// Standard Error: 4_292
			.saturating_add((Weight::from_ref_time(92_151)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
	...
	fn vest_other_locked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(55_867_945))
			// Standard Error: 5_288
			.saturating_add((Weight::from_ref_time(175_240)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Vesting Vesting (r:1 w:1)
	...
	fn vest_other_unlocked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(64_826_159))
			// Standard Error: 2_664
			.saturating_add((Weight::from_ref_time(85_992)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Vesting Vesting (r:1 w:1)
	...
	fn force_vested_transfer(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(84_265_843))
	...
	fn not_unlocking_merge_schedules(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(56_711_962))
			// Standard Error: 5_028
			.saturating_add((Weight::from_ref_time(178_369)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Vesting Vesting (r:1 w:1)
	...
	fn unlocking_merge_schedules(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(56_432_684))
			// Standard Error: 5_298
			.saturating_add((Weight::from_ref_time(177_002)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
