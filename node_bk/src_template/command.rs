...
use log::info;
use common_runtime::types::Block;
use sc_cli::{
...
fn load_spec(id: &str) -> std::result::Result<Box<dyn ChainSpec>, String> {
	Ok(match id {
		...
		// path => Box::new(chain_spec::mangata_kusama::ChainSpec::from_json_file(std::path::PathBuf::from(path))?),
		...
		path => Box::new(chain_spec::mangata_rococo::ChainSpec::from_json_file(std::path::PathBuf::from(path))?),
	})
}
