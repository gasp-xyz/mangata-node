...
impl<T: frame_system::Config> frame_system::WeightInfo for ModuleWeight<T> {
	...
	fn set_storage(i: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 0
			.saturating_add((571_000 as Weight).saturating_mul(i as Weight))
	...
	fn kill_storage(i: u32, ) -> Weight {
		(1_671_000 as Weight)
			// Standard Error: 0
			.saturating_add((398_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(i as Weight)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn kill_prefix(p: u32, ) -> Weight {
		(4_516_000 as Weight)
			...
			.saturating_add((792_000 as Weight).saturating_mul(p as Weight))
