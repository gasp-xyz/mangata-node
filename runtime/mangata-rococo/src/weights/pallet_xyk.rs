...
impl<T: frame_system::Config> pallet_xyk::WeightInfo for ModuleWeight<T> {
	...
	fn create_pool() -> Weight {
		(Weight::from_ref_time(179_230_000))
	...
	fn sell_asset() -> Weight {
		(Weight::from_ref_time(199_250_000))
			.saturating_add(T::DbWeight::get().reads(14 as u64))
	...
	// Storage: Tokens TotalIssuance (r:1 w:1)
	fn multiswap_sell_asset(x: u32, ) -> Weight {
		(Weight::from_ref_time(518_130_000))
			// Standard Error: 244_534
			.saturating_add((Weight::from_ref_time(195_990_966)).saturating_mul(x as u64))
	...
	// Storage: System Account (r:2 w:2)
	fn buy_asset() -> Weight {
		(Weight::from_ref_time(203_830_000))
	...
	// Storage: Tokens TotalIssuance (r:1 w:1)
	fn multiswap_buy_asset(x: u32, ) -> Weight {
		(Weight::from_ref_time(526_600_000))
			// Standard Error: 249_259
			.saturating_add((Weight::from_ref_time(201_969_870)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().reads((8 as u64).saturating_mul(x as u64)))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
			.saturating_add(T::DbWeight::get().writes((6 as u64).saturating_mul(x as u64)))
	...
	fn mint_liquidity() -> Weight {
		(Weight::from_ref_time(208_180_000))
			.saturating_add(T::DbWeight::get().reads(15 as u64))
	...
	// Storage: Tokens NextCurrencyId (r:1 w:0)
	fn mint_liquidity_using_vesting_native_tokens() -> Weight {
		(Weight::from_ref_time(229_410_000))
			.saturating_add(T::DbWeight::get().reads(14 as u64))
	...
	// Storage: Xyk LiquidityPools (r:0 w:1)
	fn burn_liquidity() -> Weight {
		(Weight::from_ref_time(193_420_000))
			.saturating_add(T::DbWeight::get().reads(14 as u64))
	...
	// Storage: ProofOfStake PromotedPoolRewards (r:1 w:0)
	fn provide_liquidity_with_conversion() -> Weight {
		(Weight::from_ref_time(312_080_000))
	...
	// Storage: ProofOfStake TotalActivatedLiquidity (r:1 w:1)
	fn compound_rewards() -> Weight {
		(Weight::from_ref_time(435_690_000))
