...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for ModuleWeight<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		(Weight::from_ref_time(1_219_757_000))
			// Standard Error: 125_000
			.saturating_add((Weight::from_ref_time(52_595_000)).saturating_mul(x as u64))
	...
	// Storage: Tokens TotalIssuance (r:1 w:1)
	fn associate_native_identity() -> Weight {
		(Weight::from_ref_time(141_340_000))
			.saturating_add(T::DbWeight::get().reads(6 as u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		(Weight::from_ref_time(44_106_000))
			...
			.saturating_add((Weight::from_ref_time(62_603_000)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
