...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for ModuleWeight<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		(Weight::from_parts(141_666_911, 0))
			// Standard Error: 73_439
			.saturating_add((Weight::from_parts(26_080_457, 0)).saturating_mul(x as u64))
	...
	fn claim() -> Weight {
		(Weight::from_parts(131_760_000, 0))
	...
	// Proof: `Crowdloan::AccountsPayable` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn associate_native_identity() -> Weight {
		(Weight::from_parts(115_070_000, 0))
	...
	// Proof: `Crowdloan::AccountsPayable` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		(Weight::from_parts(22_606_472, 0))
			// Standard Error: 117_254
			.saturating_add((Weight::from_parts(62_758_102, 0)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
