...
impl<T: frame_system::Config> pallet_issuance::WeightInfo for ModuleWeight<T> {
	...
	// Proof Skipped: Issuance IsTGEFinalized (max_values: Some(1), max_size: None, mode: Measured)
	...
	// Proof Skipped: Issuance IsTGEFinalized (max_values: Some(1), max_size: None, mode: Measured)
	fn finalize_tge() -> Weight {
		(Weight::from_parts(15_849_000, 0))
	...
	// Proof Skipped: Issuance TGETotal (max_values: Some(1), max_size: None, mode: Measured)
	fn execute_tge(x: u32, ) -> Weight {
		(Weight::from_parts(26_585_737, 0))
			// Standard Error: 16_829
			.saturating_add((Weight::from_parts(83_061_110, 0)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
