...
// 20
// --output
// ./benchmarks/pallet_issuance_weights.rs
// --template
...
impl<T: frame_system::Config> pallet_issuance::WeightInfo for ModuleWeight<T> {
	...
	fn init_issuance_config() -> Weight {
		(Weight::from_ref_time(28_777_000))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Issuance IsTGEFinalized (r:1 w:1)
	fn finalize_tge() -> Weight {
		(Weight::from_ref_time(17_351_000))
	...
	fn execute_tge(x: u32, ) -> Weight {
		(Weight::from_ref_time(49_440_000))
			// Standard Error: 12_000
			.saturating_add((Weight::from_ref_time(47_248_000)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
