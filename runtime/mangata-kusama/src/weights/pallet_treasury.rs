...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for ModuleWeight<T> {
	...
	fn propose_spend() -> Weight {
		(Weight::from_parts(46_150_000, 0))
	...
	fn approve_proposal(p: u32, ) -> Weight {
		(Weight::from_parts(20_564_531, 0))
			// Standard Error: 1_841
			.saturating_add((Weight::from_parts(64_381, 0)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	// Proof: Tokens TotalIssuance (max_values: None, max_size: Some(28), added: 2503, mode: MaxEncodedLen)
	fn on_initialize_proposals(p: u32, ) -> Weight {
		(Weight::from_parts(41_108_943, 0))
			// Standard Error: 7_113
			.saturating_add((Weight::from_parts(4_261_200, 0)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
