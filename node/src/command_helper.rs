...
pub fn create_extrinsic(
	...
	let extra: mangata_kusama_runtime::SignedExtra = (
		...
		pallet_transaction_payment::ChargeTransactionPayment::<mangata_kusama_runtime::Runtime>::from(
			tip
		),
	);
...
pub struct BenchmarkExtrinsicBuilder {
	client: Arc<KusamaFullClient>,
}

#[cfg(feature = "mangata-kusama")]
impl BenchmarkExtrinsicBuilder {
	/// Creates a new [`Self`] from the given client.
	pub fn new(client: Arc<KusamaFullClient>) -> Self {
		Self { client }
	}
}
