...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_parts(9_547_364, 0))
			// Standard Error: 3_907
			.saturating_add((Weight::from_parts(9_787_750, 0)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_parts(10_100_000, 0))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_parts(9_586_041, 0))
			// Standard Error: 3_411
			.saturating_add((Weight::from_parts(10_269_425, 0)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_parts(17_000_000, 0))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_parts(13_747_173, 0))
			// Standard Error: 3_163
			.saturating_add((Weight::from_parts(9_823_460, 0)).saturating_mul(c as u64))
	}
}
