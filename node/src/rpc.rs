...
use mangata_primitives::{AccountId, Balance, Block, BlockNumber, Index as Nonce, TokenId};
...
where
	C: ProvideRuntimeApi<Block>
		...
		+ Sync
		+ 'static,
	C::Api: pallet_transaction_payment_rpc_mangata::TransactionPaymentRuntimeApi<Block, Balance>,
...
{
	use pallet_transaction_payment_rpc_mangata::{TransactionPayment, TransactionPaymentApiServer};
