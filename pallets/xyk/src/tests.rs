...
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), 872);
...
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), 2844);
...
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), 7707);
// 		System::set_block_number(80000);
// 		MockPromotedPoolApi::instance()
// 			.lock()
// 			.unwrap()
// 			.insert(4, U256::from(u128::MAX) * 8);
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), 9816);
// 		System::set_block_number(90000);
// 		MockPromotedPoolApi::instance()
// 			.lock()
// 			.unwrap()
// 			.insert(4, U256::from(u128::MAX) * 9);
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), 12141);
// 		System::set_block_number(100000);
// 		MockPromotedPoolApi::instance()
// 			.lock()
// 			.unwrap()
// 			.insert(4, U256::from(u128::MAX) * 10);
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), 14700);
// 	});
// }
...
// 			.insert(4, U256::from(u128::MAX) * 100000 / 10000);
// 		System::set_block_number(100000);
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), 2559);
// 	});
// }
...
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(4, 4).unwrap(), 945);
...
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(3, 4).unwrap(), 14700);
// 		XykStorage::claim_rewards_v2(Origin::signed(3), 4, 14700).unwrap();
// 	});
// }
...
// 		System::set_block_number(100000);
// 		assert_eq!(XykStorage::calculate_rewards_amount_v2(2, 4).unwrap(), u128::MAX / 10);
// 	});
// }
...
// 		XykStorage::create_pool(Origin::signed(2), 0, 1000000000000000000, 1, 1000000000000000000).unwrap();
// 		XykStorage::promote_pool(Origin::root(), 4).unwrap();
// 		MockPromotedPoolApi::instance()
// 			.lock()
// 			.unwrap()
// 			.insert(4, U256::from(u128::MAX) * U256::from(0));
// 		XykStorage::transfer(0, 2, 3, 1000000000000000000000).unwrap();
// 		XykStorage::transfer(1, 2, 3, 1000000000000000000000).unwrap();
// 		XykStorage::transfer(0, 2, 4, 1000000000000000000000).unwrap();
// 		XykStorage::transfer(1, 2, 4, 1000000000000000000000).unwrap();
// 		XykStorage::activate_liquidity_v2(Origin::signed(2), 4, 1000000, None).unwrap();
// 		XykStorage::mint_liquidity(Origin::signed(3), 0, 1, 1000000, 1000010).unwrap();
...
// 					.lock()
// 					.unwrap()
// 					.insert(4, U256::from(u128::MAX) * U256::from((i + 1)));
// 			}
// 			if i % 5 == 0 {
// 				log::info!("_______________minting");
// 				XykStorage::mint_liquidity(Origin::signed(3), 0, 1, 1, 2).unwrap();
// 			}

// 			log::info!("================");
// 			let r1 = XykStorage::calculate_rewards_amount_v2(2, 4).unwrap();
// 			let r2 = XykStorage::calculate_rewards_amount_v2(3, 4).unwrap();
// 			let r3 = XykStorage::calculate_rewards_amount_v2(4, 4).unwrap();
// 			log::info!("2   {} , {}", i, r1);
// 			log::info!("3   {} , {}", i, r2);
// 			log::info!("4   {} , {}", i, r3);
...
// 			log::info!("ccccccccccccccc  {},{},{}",n,m,a)
// 		}
// 	});
// }
...
// 		XykStorage::transfer(0, 2, 4, 1000000000000000000000).unwrap();
// 		XykStorage::transfer(1, 2, 4, 1000000000000000000000).unwrap();
// 		XykStorage::transfer(0, 2, 5, 1000000000000000000000).unwrap();
// 		XykStorage::transfer(1, 2, 5, 1000000000000000000000).unwrap();
// 		XykStorage::activate_liquidity_v2(Origin::signed(2), 4, 1000, None).unwrap();
// 		XykStorage::mint_liquidity(Origin::signed(3), 0, 1, 1000, 1010).unwrap();
// 		XykStorage::mint_liquidity(Origin::signed(4), 0, 1, 1000, 1010).unwrap();
// 		XykStorage::mint_liquidity(Origin::signed(5), 0, 1, 1000, 1010).unwrap();
...
// 		log::info!("{}",XykStorage::calculate_rewards_amount_v2(5, 4).unwrap());

// 		System::set_block_number(1000);
// 		MockPromotedPoolApi::instance()
// 			.lock()
// 			.unwrap()
// 			.insert(4, U256::from(u128::MAX) * U256::from(100));
...
// 		log::info!("ooooooooooooooooooooooooo");
// 		XykStorage::mint_liquidity(Origin::signed(3), 0, 1, 100000000, 100000010).unwrap();
// 		XykStorage::mint_liquidity(Origin::signed(4), 0, 1, 100000000, 100000010).unwrap();
// 		XykStorage::mint_liquidity(Origin::signed(5), 0, 1, 100000000, 100000010).unwrap();
...
// 			.lock()
// 			.unwrap()
// 			.insert(4, U256::from(u128::MAX) * U256::from(1000));
...
// 		)
// 		.unwrap();
// 		XykStorage::create_pool(Origin::signed(2), 0, 250000000000000000000000000, 1, 10000000000000000).unwrap();
// 		XykStorage::promote_pool(Origin::root(), 4).unwrap();
// 		MockPromotedPoolApi::instance()
// 			.lock()
// 			.unwrap()
...
// 		XykStorage::mint_liquidity(Origin::signed(2), 0, 1, 25000000000000000000000, 2000000000000).unwrap();
// 		XykStorage::mint_liquidity(Origin::signed(3), 0, 1, 25000000000000000000000, 2000000000000).unwrap();
...
// 			XykStorage::mint_liquidity(Origin::signed(3), 0, 1, 34000000000000000000, 68000000000000000000).unwrap();
// 			log::info!("----------------------------");
...
// 				higher_rewards_cumulative =rew_minter * 10000 / rew_non_minter + higher_rewards_cumulative ;
// 			}
// 			}
// 		}
...
fn migration_work() {
    new_test_ext().execute_with(|| {
        ...
        XykStorage::set_liquidity_minting_checkpoint(2,4,10000, None);

        System::set_block_number(100);
        MockPromotedPoolApi::instance()
			.lock()
			.unwrap()
			.insert(4, U256::from(100000));
       
        XykStorage::set_liquidity_minting_checkpoint(3,4,10000, None);

        System::set_block_number(200);    
        MockPromotedPoolApi::instance()
        .lock()
        .unwrap()
        .insert(4, U256::from(200000));
