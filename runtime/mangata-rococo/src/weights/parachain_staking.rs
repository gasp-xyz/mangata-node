...
impl<T: frame_system::Config> parachain_staking::WeightInfo for ModuleWeight<T> {
	...
	fn join_candidates(x: u32, y: u32, ) -> Weight {
		(Weight::from_parts(119_544_784, 0))
			// Standard Error: 9_354
			.saturating_add((Weight::from_parts(150_604, 0)).saturating_mul(x as u64))
			// Standard Error: 9_240
			.saturating_add((Weight::from_parts(199_000, 0)).saturating_mul(y as u64))
	...
	// Proof: `ParachainStaking::CandidatePool` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn schedule_leave_candidates(x: u32, ) -> Weight {
		(Weight::from_parts(37_830_404, 0))
			// Standard Error: 2_680
			.saturating_add((Weight::from_parts(123_243, 0)).saturating_mul(x as u64))
	...
	// Proof: `ParachainStaking::Total` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn execute_leave_candidates(x: u32, ) -> Weight {
		(Weight::from_parts(66_566_597, 0))
			// Standard Error: 102_929
			.saturating_add((Weight::from_parts(31_808_468, 0)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
	...
	// Proof: `ParachainStaking::CandidatePool` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn cancel_leave_candidates(x: u32, ) -> Weight {
		(Weight::from_parts(36_344_898, 0))
			// Standard Error: 2_734
			.saturating_add((Weight::from_parts(125_362, 0)).saturating_mul(x as u64))
	...
	// Proof: `ParachainStaking::Round` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn go_online() -> Weight {
		(Weight::from_parts(34_930_000, 0))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: `ParachainStaking::CandidateState` (r:1 w:1)
	...
	// Proof: `ParachainStaking::Round` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn schedule_candidate_bond_more() -> Weight {
		(Weight::from_parts(54_580_000, 0))
	...
	// Proof: `ParachainStaking::Round` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn schedule_candidate_bond_less() -> Weight {
		(Weight::from_parts(56_670_000, 0))
	...
	// Proof: `ParachainStaking::CandidatePool` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn execute_candidate_bond_more() -> Weight {
		(Weight::from_parts(107_800_000, 0))
	...
	// Proof: `ParachainStaking::Total` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn delegate(x: u32, y: u32, ) -> Weight {
		(Weight::from_parts(126_212_793, 0))
			// Standard Error: 20_241
			.saturating_add((Weight::from_parts(152_166, 0)).saturating_mul(x as u64))
			// Standard Error: 19_560
			.saturating_add((Weight::from_parts(281_095, 0)).saturating_mul(y as u64))
	...
	// Proof: `ParachainStaking::Total` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn execute_leave_delegators(x: u32, ) -> Weight {
		(Weight::from_parts(35_710_474, 0))
			// Standard Error: 117_122
			.saturating_add((Weight::from_parts(39_255_172, 0)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(5 as u64))
	...
	// Proof: `ParachainStaking::Round` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn schedule_revoke_delegation() -> Weight {
		(Weight::from_parts(32_850_000, 0))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: `ParachainStaking::DelegatorState` (r:1 w:1)
	...
	// Proof: `ParachainStaking::Round` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn schedule_delegator_bond_more() -> Weight {
		(Weight::from_parts(52_540_000, 0))
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: `ParachainStaking::DelegatorState` (r:1 w:1)
	...
	// Proof: `ParachainStaking::Total` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn execute_revoke_delegation() -> Weight {
		(Weight::from_parts(114_340_000, 0))
	...
	// Proof: `ParachainStaking::Total` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn execute_delegator_bond_more() -> Weight {
		(Weight::from_parts(126_549_000, 0))
			.saturating_add(T::DbWeight::get().reads(7 as u64))
			.saturating_add(T::DbWeight::get().writes(6 as u64))
	}
	// Storage: `ParachainStaking::DelegatorState` (r:1 w:1)
	...
	// Proof: `ParachainStaking::DelegatorState` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn cancel_delegator_bond_less() -> Weight {
		(Weight::from_parts(37_670_000, 0))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: `Xyk::LiquidityPools` (r:1 w:0)
	...
	// Proof: `ParachainStaking::StakingLiquidityTokens` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn add_staking_liquidity_token(x: u32, ) -> Weight {
		(Weight::from_parts(26_409_191, 0))
			// Standard Error: 2_820
			.saturating_add((Weight::from_parts(165_180, 0)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: `ParachainStaking::StakingLiquidityTokens` (r:1 w:1)
	// Proof: `ParachainStaking::StakingLiquidityTokens` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn remove_staking_liquidity_token(x: u32, ) -> Weight {
		(Weight::from_parts(20_007_922, 0))
			// Standard Error: 2_592
			.saturating_add((Weight::from_parts(136_166, 0)).saturating_mul(x as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	// Proof: `ParachainStaking::CandidateAggregator` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn aggregator_update_metadata() -> Weight {
		(Weight::from_parts(1_661_170_000, 0))
	...
	// Proof: `ParachainStaking::AggregatorMetadata` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn update_candidate_aggregator() -> Weight {
		(Weight::from_parts(109_320_000, 0))
			.saturating_add(T::DbWeight::get().reads(4 as u64))
	...
	fn payout_collator_rewards() -> Weight {
		(Weight::from_parts(1_510_580_000, 0))
	...
	// Proof: `System::Account` (`max_values`: None, `max_size`: Some(64), added: 2539, mode: `MaxEncodedLen`)
	fn payout_delegator_reward() -> Weight {
		(Weight::from_parts(82_730_000, 0))
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().writes(4 as u64))
	}
	// Storage: `ParachainStaking::Round` (r:1 w:0)
	...
	fn active_session_change(x: u32, y: u32, z: u32, ) -> Weight {
		(Weight::from_parts(1_742_061_893, 0))
			// Standard Error: 91_439
			.saturating_add((Weight::from_parts(19_003_727, 0)).saturating_mul(x as u64))
			// Standard Error: 187_519
			.saturating_add((Weight::from_parts(7_513_684, 0)).saturating_mul(y as u64))
			// Standard Error: 324_806
			.saturating_add((Weight::from_parts(39_182_626, 0)).saturating_mul(z as u64))
