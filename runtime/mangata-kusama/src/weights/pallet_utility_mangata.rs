...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_ref_time(27_203_139))
			// Standard Error: 1_472
			.saturating_add((Weight::from_ref_time(7_123_821)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_ref_time(10_630_000))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_ref_time(23_138_268))
			// Standard Error: 1_567
			.saturating_add((Weight::from_ref_time(7_367_371)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_ref_time(21_770_000))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_ref_time(29_994_533))
			// Standard Error: 1_687
			.saturating_add((Weight::from_ref_time(7_112_405)).saturating_mul(c as u64))
	}
}
