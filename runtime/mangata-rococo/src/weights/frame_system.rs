...
impl<T: frame_system::Config> frame_system::WeightInfo for ModuleWeight<T> {
	fn remark(b: u32, ) -> Weight {
		(Weight::from_parts(8_068_407, 0))
			// Standard Error: 0
			.saturating_add((Weight::from_parts(301, 0)).saturating_mul(b as u64))
	}
	fn remark_with_event(b: u32, ) -> Weight {
		(Weight::from_parts(8_629_253, 0))
			// Standard Error: 3
			.saturating_add((Weight::from_parts(1_566, 0)).saturating_mul(b as u64))
	}
	...
	fn set_code() -> Weight {
		(Weight::from_parts(153_609_518_000, 0))
	...
	fn set_storage(i: u32, ) -> Weight {
		(Weight::from_parts(4_029_000, 0))
			...
			.saturating_add((Weight::from_parts(1_209_775, 0)).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		(Weight::from_parts(3_660_000, 0))
			...
			.saturating_add((Weight::from_parts(781_486, 0)).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: `Skipped::Metadata` (r:0 w:0)
	// Proof: `Skipped::Metadata` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn kill_prefix(p: u32, ) -> Weight {
		(Weight::from_parts(6_871_000, 0))
			...
			.saturating_add((Weight::from_parts(1_353_159, 0)).saturating_mul(p as u64))
