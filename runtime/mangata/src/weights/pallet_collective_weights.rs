...
impl<T: frame_system::Config> pallet_collective::WeightInfo for ModuleWeight<T> {
	...
	fn set_members(m: u32, n: u32, p: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((15_566_000 as Weight).saturating_mul(m as Weight))
			// Standard Error: 6_000
			.saturating_add((172_000 as Weight).saturating_mul(n as Weight))
			// Standard Error: 6_000
			.saturating_add((19_757_000 as Weight).saturating_mul(p as Weight))
