...
decl_test_parachain! {
	pub struct Mangata {
		...
		XcmpMessageHandler = mangata_kusama_runtime::XcmpQueue,
		DmpMessageHandler = mangata_kusama_runtime::DmpQueue,
...
pub fn kusama_ext() -> sp_io::TestExternalities {
	...
	pallet_balances::GenesisConfig::<Runtime> {
		balances: vec![
			(AccountId::from(ALICE), 1_000_000_000_000_000),
			(ParaId::from(2110).into_account_truncating(), 10_000_000_000_000),
		],
	}
