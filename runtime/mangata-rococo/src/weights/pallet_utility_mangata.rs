...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_parts(16_589_619, 0))
			// Standard Error: 16_418
			.saturating_add((Weight::from_parts(10_132_634, 0)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_parts(9_780_000, 0))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_parts(54_293_178, 0))
			// Standard Error: 22_178
			.saturating_add((Weight::from_parts(10_507_277, 0)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_parts(16_940_000, 0))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_parts(24_129_155, 0))
			// Standard Error: 21_663
			.saturating_add((Weight::from_parts(10_054_761, 0)).saturating_mul(c as u64))
	}
}
