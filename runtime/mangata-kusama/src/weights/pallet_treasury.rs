...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for ModuleWeight<T> {
	fn spend() -> Weight {
		(Weight::from_ref_time(371_000))
	}
	// Storage: Tokens Accounts (r:1 w:1)
	// Storage: Treasury ProposalCount (r:1 w:1)
	// Storage: Treasury Proposals (r:0 w:1)
	fn propose_spend() -> Weight {
		(Weight::from_ref_time(46_920_000))
	...
	fn reject_proposal() -> Weight {
		(Weight::from_ref_time(53_080_000))
	...
	fn approve_proposal(p: u32, ) -> Weight {
		(Weight::from_ref_time(20_847_608))
			// Standard Error: 1_572
			.saturating_add((Weight::from_ref_time(91_776)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Treasury Approvals (r:1 w:1)
	fn remove_approval() -> Weight {
		(Weight::from_ref_time(14_040_000))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		(Weight::from_ref_time(40_206_246))
			// Standard Error: 6_747
			.saturating_add((Weight::from_ref_time(3_467_705)).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
