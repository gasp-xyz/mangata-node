...
impl<T: frame_system::Config> parachain_staking::WeightInfo for ModuleWeight<T> {
	...
	fn join_candidates(x: u32, y: u32, ) -> Weight {
		(60_975_000 as Weight)
			...
			.saturating_add((100_000 as Weight).saturating_mul(y as Weight))
	...
	// Storage: ParachainStaking CandidatePool (r:1 w:1)
	fn schedule_leave_candidates(x: u32, ) -> Weight {
		(36_190_000 as Weight)
			// Standard Error: 7_000
			.saturating_add((361_000 as Weight).saturating_mul(x as Weight))
	...
	fn execute_leave_candidates(x: u32, ) -> Weight {
		(35_538_000 as Weight)
			...
			.saturating_add((19_555_000 as Weight).saturating_mul(x as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
	...
	fn delegate(x: u32, y: u32, ) -> Weight {
		(66_641_000 as Weight)
			...
			.saturating_add((462_000 as Weight).saturating_mul(y as Weight))
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
	...
	fn execute_leave_delegators(x: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((29_947_000 as Weight).saturating_mul(x as Weight))
	...
	fn add_staking_liquidity_token(x: u32, ) -> Weight {
		(7_706_000 as Weight)
			// Standard Error: 0
			.saturating_add((93_000 as Weight).saturating_mul(x as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	// Storage: ParachainStaking StakingLiquidityTokens (r:1 w:1)
	...
	fn active_session_change(x: u32, y: u32, z: u32, w: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((23_162_000 as Weight).saturating_mul(x as Weight))
			// Standard Error: 1_956_000
			.saturating_add((133_592_000 as Weight).saturating_mul(y as Weight))
			// Standard Error: 15_182_000
			.saturating_add((737_108_000 as Weight).saturating_mul(z as Weight))
			// Standard Error: 7_597_000
			.saturating_add((459_162_000 as Weight).saturating_mul(w as Weight))
			.saturating_add(T::DbWeight::get().reads((4 as Weight).saturating_mul(x as Weight)))
			.saturating_add(T::DbWeight::get().reads((9 as Weight).saturating_mul(y as Weight)))
			.saturating_add(T::DbWeight::get().reads((50 as Weight).saturating_mul(z as Weight)))
			.saturating_add(T::DbWeight::get().reads((33 as Weight).saturating_mul(w as Weight)))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(x as Weight)))
			.saturating_add(T::DbWeight::get().writes((9 as Weight).saturating_mul(y as Weight)))
			.saturating_add(T::DbWeight::get().writes((49 as Weight).saturating_mul(z as Weight)))
			.saturating_add(T::DbWeight::get().writes((32 as Weight).saturating_mul(w as Weight)))
	}
}
...
impl WeightInfo for () {
	...
	fn active_session_change(x: u32, y: u32, z: u32, w: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add(RocksDbWeight::get().reads((9 as Weight).saturating_mul(y as Weight)))
			.saturating_add(RocksDbWeight::get().reads((50 as Weight).saturating_mul(z as Weight)))
			.saturating_add(RocksDbWeight::get().reads((33 as Weight).saturating_mul(w as Weight)))
			.saturating_add(RocksDbWeight::get().writes((1 as Weight).saturating_mul(x as Weight)))
			.saturating_add(RocksDbWeight::get().writes((9 as Weight).saturating_mul(y as Weight)))
			.saturating_add(RocksDbWeight::get().writes((49 as Weight).saturating_mul(z as Weight)))
			.saturating_add(RocksDbWeight::get().writes((32 as Weight).saturating_mul(w as Weight)))
	}
}
