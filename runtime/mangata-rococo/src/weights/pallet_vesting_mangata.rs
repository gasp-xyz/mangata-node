...
impl<T: frame_system::Config> pallet_vesting_mangata::WeightInfo for ModuleWeight<T> {
	...
	fn vest_locked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(62_733_751))
			// Standard Error: 6_268
			.saturating_add((Weight::from_ref_time(206_881)).saturating_mul(s as u64))
	...
	fn vest_unlocked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(74_794_178))
			// Standard Error: 4_451
			.saturating_add((Weight::from_ref_time(76_471)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
	...
	fn vest_other_locked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(60_790_283))
			// Standard Error: 6_272
			.saturating_add((Weight::from_ref_time(199_199)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Vesting Vesting (r:1 w:1)
	...
	fn vest_other_unlocked(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(69_810_579))
			// Standard Error: 3_691
			.saturating_add((Weight::from_ref_time(107_692)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Vesting Vesting (r:1 w:1)
	...
	fn force_vested_transfer(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(90_460_390))
			// Standard Error: 6_808
			.saturating_add((Weight::from_ref_time(197_574)).saturating_mul(s as u64))
	...
	fn not_unlocking_merge_schedules(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(60_380_124))
			// Standard Error: 5_972
			.saturating_add((Weight::from_ref_time(207_531)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Vesting Vesting (r:1 w:1)
	...
	fn unlocking_merge_schedules(_l: u32, s: u32, ) -> Weight {
		(Weight::from_ref_time(60_110_885))
			// Standard Error: 6_346
			.saturating_add((Weight::from_ref_time(192_636)).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
