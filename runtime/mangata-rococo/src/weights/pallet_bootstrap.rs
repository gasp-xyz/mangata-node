...
impl<T: frame_system::Config> pallet_bootstrap::WeightInfo for ModuleWeight<T> {
	...
	// Proof Skipped: Bootstrap Phase (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Bootstrap BootstrapSchedule (r:1 w:1)
	// Proof Skipped: Bootstrap BootstrapSchedule (max_values: Some(1), max_size: None, mode: Measured)
	...
	// Proof Skipped: Bootstrap PromoteBootstrapPool (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Bootstrap ActivePair (r:0 w:1)
	// Proof Skipped: Bootstrap ActivePair (max_values: Some(1), max_size: None, mode: Measured)
	fn schedule_bootstrap() -> Weight {
	...
	// Proof Skipped: Bootstrap WhitelistedAccount (max_values: None, max_size: None, mode: Measured)
	...
	// Proof Skipped: Bootstrap Provisions (max_values: None, max_size: None, mode: Measured)
	// Storage: Bootstrap Valuations (r:1 w:1)
	// Proof Skipped: Bootstrap Valuations (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Bootstrap ProvisionAccounts (r:0 w:1)
	// Proof Skipped: Bootstrap ProvisionAccounts (max_values: None, max_size: None, mode: Measured)
	fn provision() -> Weight {
		(Weight::from_parts(106_729_000, 0))
	...
	// Proof Skipped: Bootstrap MintedLiquidity (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Bootstrap ArchivedBootstrap (r:1 w:0)
	// Proof Skipped: Bootstrap ArchivedBootstrap (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Bootstrap ActivePair (r:1 w:0)
	// Proof Skipped: Bootstrap ActivePair (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Bootstrap ClaimedRewards (r:2 w:2)
	// Proof Skipped: Bootstrap ClaimedRewards (max_values: None, max_size: None, mode: Measured)
	// Storage: Bootstrap Valuations (r:1 w:0)
	// Proof Skipped: Bootstrap Valuations (max_values: Some(1), max_size: None, mode: Measured)
	// Storage: Bootstrap Provisions (r:2 w:0)
	// Proof Skipped: Bootstrap Provisions (max_values: None, max_size: None, mode: Measured)
	// Storage: Bootstrap VestedProvisions (r:2 w:0)
	// Proof Skipped: Bootstrap VestedProvisions (max_values: None, max_size: None, mode: Measured)
	// Storage: Tokens Accounts (r:2 w:2)
	// Proof: Tokens Accounts (max_values: None, max_size: Some(108), added: 2583, mode: MaxEncodedLen)
	...
	// Proof Skipped: Bootstrap ProvisionAccounts (max_values: None, max_size: None, mode: Measured)
	fn claim_and_activate_liquidity_tokens() -> Weight {
		(Weight::from_parts(226_960_000, 0))
	...
	// Proof Skipped: Bootstrap ActivePair (max_values: Some(1), max_size: None, mode: Measured)
	fn finalize() -> Weight {
		(Weight::from_parts(79_150_000, 0))
			.saturating_add(T::DbWeight::get().reads(10 as u64))
