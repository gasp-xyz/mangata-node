...
use hex_literal::hex;
use mangata_runtime::{
    AccountId, AssetsInfoConfig, BabeConfig, BalancesConfig, BridgedAssetConfig, GenesisConfig,
...
fn testnet_genesis(
    ...
    GenesisConfig {
        ...
        pallet_assets_info: Some(AssetsInfoConfig {
            bridged_assets_info: _bridged_assets
                .iter()
                .cloned()
                .map(|x| {
        ...
        bridged_asset: Some(BridgedAssetConfig {
            bridged_assets_links: _bridged_assets
                .iter()
                .cloned()
                .map(|x| {
