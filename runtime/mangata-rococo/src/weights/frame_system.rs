...
impl<T: frame_system::Config> frame_system::WeightInfo for ModuleWeight<T> {
	fn remark(b: u32, ) -> Weight {
		(Weight::from_parts(3_960_000, 0))
			// Standard Error: 0
			.saturating_add((Weight::from_parts(402, 0)).saturating_mul(b as u64))
	}
	fn remark_with_event(b: u32, ) -> Weight {
		(Weight::from_parts(12_890_000, 0))
			// Standard Error: 0
			.saturating_add((Weight::from_parts(1_688, 0)).saturating_mul(b as u64))
	}
	...
	fn set_code() -> Weight {
		(Weight::from_parts(164_512_187_000, 0))
	...
	fn set_storage(i: u32, ) -> Weight {
		(Weight::from_parts(4_120_000, 0))
			...
			.saturating_add((Weight::from_parts(1_335_517, 0)).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		(Weight::from_parts(4_110_000, 0))
			...
			.saturating_add((Weight::from_parts(915_035, 0)).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
	}
	// Storage: `Skipped::Metadata` (r:0 w:0)
	// Proof: `Skipped::Metadata` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn kill_prefix(p: u32, ) -> Weight {
		(Weight::from_parts(7_640_000, 0))
			...
			.saturating_add((Weight::from_parts(1_597_399, 0)).saturating_mul(p as u64))
