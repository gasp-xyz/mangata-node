...
impl<T: frame_system::Config> pallet_utility::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_ref_time(22_721_000))
			...
			.saturating_add((Weight::from_ref_time(6_650_000)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_ref_time(12_080_000))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_ref_time(29_552_000))
			// Standard Error: 1_000
			.saturating_add((Weight::from_ref_time(6_827_000)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_ref_time(23_160_000))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_ref_time(30_838_000))
			// Standard Error: 1_000
			.saturating_add((Weight::from_ref_time(6_540_000)).saturating_mul(c as u64))
	}
}
