...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_parts(19_140_183, 0))
			// Standard Error: 3_444
			.saturating_add((Weight::from_parts(9_410_608, 0)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_parts(10_120_000, 0))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_parts(14_978_625, 0))
			// Standard Error: 2_992
			.saturating_add((Weight::from_parts(9_802_086, 0)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_parts(16_510_000, 0))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_parts(18_073_256, 0))
			// Standard Error: 3_525
			.saturating_add((Weight::from_parts(9_368_770, 0)).saturating_mul(c as u64))
	}
}
