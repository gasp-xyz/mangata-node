...
impl<T: frame_system::Config> orml_tokens::WeightInfo for ModuleWeight<T> {
	...
	fn transfer() -> Weight {
		(Weight::from_ref_time(56_869_000))
	...
	// Storage: System Account (r:1 w:1)
	fn transfer_all() -> Weight {
		(Weight::from_ref_time(59_260_000))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Tokens Accounts (r:2 w:2)
	// Storage: System Account (r:1 w:1)
	fn transfer_keep_alive() -> Weight {
		(Weight::from_ref_time(52_511_000))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Tokens Accounts (r:2 w:2)
	...
	fn force_transfer() -> Weight {
		(Weight::from_ref_time(55_160_000))
	...
	fn set_balance() -> Weight {
		(Weight::from_ref_time(34_150_000))
	...
	// Storage: System Account (r:1 w:1)
	fn create() -> Weight {
		(Weight::from_ref_time(57_310_000))
			.saturating_add(T::DbWeight::get().reads(4 as u64))
