...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_parts(15_135_963, 0))
			// Standard Error: 5_453
			.saturating_add((Weight::from_parts(9_834_773, 0)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_parts(9_310_000, 0))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_parts(19_212_890, 0))
			// Standard Error: 5_692
			.saturating_add((Weight::from_parts(10_267_333, 0)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_parts(16_010_000, 0))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_parts(9_766_534, 0))
			// Standard Error: 4_956
			.saturating_add((Weight::from_parts(9_840_630, 0)).saturating_mul(c as u64))
	}
}
