...
fn buy_and_burn_sell_mangata() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (149950000000000, 66733400066734));
...
fn buy_and_burn_sell_other_for_mangata() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (66711155600046, 150000000000000));
...
fn buy_and_burn_sell_only_sold_has_mangata_pair() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((1, 3)), (149950000000000, 66733400066734));
        assert_eq!(XykStorage::balance(1, 2), 650000000000000); // user acc: regular trade result
...
fn buy_and_burn_sell_only_bought_has_mangata_pair() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (99977758007120, 100022244466688));
        ...
        assert_eq!(XykStorage::asset_pool((1, 3)), (66711155600046, 150000000000000));
        assert_eq!(XykStorage::balance(1, 2), 733266599933266); // user acc: regular trade result
...
fn buy_and_burn_sell_both_have_mangata_pair() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((1, 2)), (66711155600046, 150000000000000));
        assert_eq!(XykStorage::balance(1, 2), 733266599933266); // user acc: regular trade result
...
fn buy_and_burn_sell_none_have_mangata_pair() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((3, 4)), (150000000000000, 66711155600046));
        assert_eq!(XykStorage::balance(3, 2), 750000000000000); // user acc - regular trade result
...
fn multi() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (1000000000000000000000000, 500000000000000000000000));
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (1500000000000000000000000, 750000000000000000000001));
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (1200000000000000000000000, 600000000000000000000001));
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (900000000000000000000000, 450000000000000000000001));
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (1900000000000000000000000, 950000000000000000000003));
...
fn create_pool_W() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (40000000000000000000, 60000000000000000000));
        assert_eq!(XykStorage::liquidity_asset((0, 1)), Some(2)); // liquidity assetId corresponding to newly created pool
        assert_eq!(XykStorage::liquidity_pool(2), Some((0, 1))); // liquidity assetId corresponding to newly created pool
...
fn sell_W() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (59980000000000000000,40040040040040040041)); // amount of asset 0 in pool map
...
fn sell_W_other_way() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (26684462240017795575, 90000000000000000000));
...
fn buy_W() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (80080240722166499500, 30000000000000000000));
...
fn buy_W_other_way() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(XykStorage::asset_pool((0, 1)), (9992494370778083564, 240541624874623871615));
...
fn burn_W() {
    new_test_ext().execute_with(|| {
        ...
        // assert_eq!(XykStorage::asset_pool((1, 0)), 30000000000000000000); // amount in pool map
        assert_eq!(XykStorage::asset_pool((0, 1)), (20000000000000000000, 30000000000000000000));
